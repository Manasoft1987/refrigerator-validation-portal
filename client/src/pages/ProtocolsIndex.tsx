            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 gap-3">
                {([
                  ...
                  { id: "chamber", label: "\u0425\u043e\u043b\u043e\u0434\u0438\u043b\u044c\u043d\u0430\u044f \u043a\u0430\u043c\u0435\u0440\u0430", icon: "\u2744\uFE0F", desc: "Картирование по ЕЭК №8 · ISPE 15+1 регистратор · три 3D-схемы" },
                  ...
                  { id: "warehouse", label: "Помещение (зона) хранения аптеки", icon: "🏥", desc: "Аптечное помещение хранения с расчётом количества регистраторов по Рек. ЕЭК №8" },
