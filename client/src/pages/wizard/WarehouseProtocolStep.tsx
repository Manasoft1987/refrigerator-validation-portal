...
Картирование проводится с использованием поверенных регистраторов данных, размещаемых в соответствии с Рекомендацией Коллегии ЕЭК №8 и принципами ISPE.`,
...
— Решение Совета ЕЭК от 03.11.2016 г. № 80 «Об утверждении Правил надлежащей дистрибьюторской практики в рамках Евразийского экономического союза»;
...
— диапазон измерений: соответствует контролируемому температурному режиму зоны хранения;
...
Все внутренние регистраторы должны показывать температуру в пределах установленного диапазона на протяжении всего периода исследования.`,
  "6.5": `Количество и расположение точек размещения регистраторов данных определены в соответствии с Рекомендацией Коллегии ЕЭК №8 (п. 16д) исходя из объёма и геометрии зоны хранения. Расчёт минимального количества регистраторов приведён в разделе «Общие сведения». 
