...
const DEV_AUTH_OPEN_ID = "local-dev-admin";
const DEV_AUTH_APP_ID = "local-dev";
const DEV_AUTH_NAME = "Local Dev Admin";
const DEV_AUTH_SECRET = "local-development-session-secret";
...
export const localDevSessionPayload: SessionPayload = {
  openId: DEV_AUTH_OPEN_ID,
