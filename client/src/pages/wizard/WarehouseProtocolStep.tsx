...
— Менеджер по валидации: [ФИО, организация]`,
  "6.3": `Объект исследования — помещение (зона) хранения лекарственных средств и медицинских изделий, характеристики которой приведены в разделе «Общие сведения». Помещение хранения оснащена системой кондиционирования / отопления / вентиляции, обеспечивающей поддержание заданного температурного режима. Описание планировки, расположения стеллажей, дверей и охлаждающих агрегатов приведено в соответствующей схеме отчета квалификации.`,
