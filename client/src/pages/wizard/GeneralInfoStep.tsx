                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {isWarehouseByEaeu
                      ...
                      : "Размеры можно указать для масштаба схемы; количество датчиков специалист задаёт вручную на этапе PQ/PV."}
                  </p>
                </div>
            ...
            {supportsCustomTempMode && form.tempMode === "custom" && (
              <div className="md:col-span-2 grid md:grid-cols-2 gap-4 rounded-lg border border-blue-200 bg-blue-50/40 p-4">
                ...
                <p className="md:col-span-2 text-xs text-muted-foreground">
                  Этот диапазон будет использоваться как номинальный температурный режим в PQ/PV-расчётах и PDF.
                </p>
              </div>
            )}
          ...
          {isThermalContainer && (
            <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-5 space-y-5">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Выберите все заявленные режимы. Один из них назначается режимом текущего испытания и используется в расчетах PQ/PV.
                </p>
              </div>
