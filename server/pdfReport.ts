  ...
  if (input.pvLoggers && input.pvLoggers.length > 0) {
    ...
    if (eqType === "warehouse") {
      ...
      if (eqType === "auto-refrigerator") {
        ...
        drawRefrigeratorDiagram(doc, input.pvLoggers as DiagramSensor[], PAGE_MARGIN, null, null);
      }
      ...
      if (eqType === "auto-refrigerator") {
        ...
        drawRefrigeratorDiagram(doc, input.pvLoggers as DiagramSensor[], PAGE_MARGIN, input.coolingUnitPos, input.doorPos);
      }
    }
